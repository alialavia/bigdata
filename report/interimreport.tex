...
To measure the quality of the classifier, we set aside a part of our training data and use that as test data. On this test data we perform several metrics, such as precision, recall and F1-score.
